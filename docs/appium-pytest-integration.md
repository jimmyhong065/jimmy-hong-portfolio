...
- [Appium — Official Documentation](https://appium.io/docs/en/latest/) — Appium 官方文件，含 Session 管理與 Driver 設定
- [pytest — Fixtures Documentation](https://docs.pytest.org/en/stable/how-to/fixtures.html) — pytest fixture 機制完整說明
- [pytest — conftest.py](https://docs.pytest.org/en/stable/reference/fixtures.html#conftest-py-sharing-fixtures-across-files) — conftest.py 跨檔案共享 fixture 指南
- [Appium — Desired Capabilities](https://appium.io/docs/en/latest/guides/caps/) — Appium Capabilities 設定參考
- [Selenium Grid — Parallel Testing](https://www.selenium.dev/documentation/grid/) — 平行測試架構，可配合 Appium 使用
