...
- [Test Automation University — Observability for Test Automation](https://testautomationu.applitools.com/observability-for-test-automation/) — 本文課程來源
- [OpenTelemetry — Official Documentation](https://opentelemetry.io/docs/) — 可觀測性標準框架文件（traces / metrics / logs）
- [Grafana — What is Observability?](https://grafana.com/blog/2021/01/21/observability-defined-everything-you-need-to-know/) — 可觀測性概念入門
- [Google SRE Book — Monitoring Distributed Systems](https://sre.google/sre-book/monitoring-distributed-systems/) — 四大黃金訊號與監控原則
- [Honeycomb.io — Observability Engineering](https://info.honeycomb.io/observability-engineering-oreilly-book-2022) — O'Reilly 可觀測性工程免費電子書
