...
這是測試資料管理失控的典型症狀。根據 Capgemini 2023–24 年 World Quality Report，測試資料的準備和維護是自動化測試效率的第二大瓶頸，有超過 38% 的受訪 QA 團隊表示這直接影響了他們的測試覆蓋率和交付速度。
...
- [World Quality Report 2023-24 - Capgemini](https://www.capgemini.com/insights/research-library/world-quality-report-2023-24/)
- [Pytest Fixtures Documentation](https://docs.pytest.org/en/stable/reference/fixtures.html)
- [Test Data Management: Overview - ISTQB](https://www.istqb.org/certifications/certified-tester-foundation-level)
- [xUnit Test Patterns: Test Data Patterns - Gerard Meszaros](http://xunitpatterns.com/)
- [Database Testing Strategies - Ministry of Testing](https://www.ministryoftesting.com/)
