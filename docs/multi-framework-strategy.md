...
根據 OpenSignal 的研究，市場上流通的 Android 裝置型號超過兩萬種，不同廠商的 UI 定制層（MIUI、One UI 等）讓同一個 App 在不同裝置上的行為差異遠大於 iOS。在有限資源下選擇覆蓋哪些裝置，是行動測試最難決策的問題之一。
...
- [Appium 官方文件](https://appium.io/docs/en/latest/) — Appium 跨平台行動測試框架
- [Maestro 官方文件](https://maestro.mobile.dev/) — 低門檻行動 UI 測試框架
- [Espresso 官方文件](https://developer.android.com/training/testing/espresso) — Android 原生 UI 測試框架
- [XCUITest 官方文件](https://developer.apple.com/documentation/xctest) — iOS 原生測試框架，整合於 Xcode
- [BrowserStack App Automate 文件](https://www.browserstack.com/docs/app-automate/) — 雲端真實裝置測試平台，支援 Appium 腳本
