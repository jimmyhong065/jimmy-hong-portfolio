...
根據 DORA 2023 研究，採用 trunk-based development 搭配 feature flag 的高效能工程團隊，其部署頻率比低效能團隊高出數倍——但這個靈活性背後，是隱藏的測試複雜度，而且很多團隊在引入 feature flag 時沒有同步建立對應的測試策略。
...
- [Testing Code That Uses Feature Flags - LaunchDarkly Docs](https://docs.launchdarkly.com/guides/flags/testing-code)
- [OpenFeature Specification](https://openfeature.dev/)
- [Feature Flag Best Practices - Ministry of Testing](https://www.ministryoftesting.com/)
