...
根據 Capgemini《2024-25 年世界品質報告》，超過半數的組織沒有明確的發布品質標準（release quality criteria），「可以上線嗎」的答案往往取決於當下的時程壓力，而非預先定義的品質門檻。
...
DORA 2024 年的研究顯示，Elite 工程團隊的特徵之一，是擁有清楚的**變更失敗率目標**——他們不追求零缺陷，而是定義可接受的品質邊界，讓上線決策有所依據而非靠感覺拉扯。
...
1. Capgemini — *World Quality Report 2024-25*（發布品質標準與決策框架）：https://www.capgemini.com/insights/research-library/world-quality-report-2024-25/
2. DORA — *2024 State of DevOps Report*（Elite 團隊的 change failure rate 目標）：https://dora.dev/research/2024/dora-report/
3. Martin Fowler — *Is Design Dead?*（技術債與品質取捨的哲學）：https://martinfowler.com/articles/designDead.html
4. Google Testing Blog — *Flaky Tests at Google and How We Mitigate Them*：https://testing.googleblog.com/2016/05/flaky-tests-at-google-and-how-we.html
5. Ministry of Testing — *When is it OK to Ship with Known Bugs?*：https://www.ministryoftesting.com/articles/when-is-it-ok-to-ship-with-known-bugs
