...
如果有 visual regression test，這個問題在 CI 就會被抓到。根據 BrowserStack 的研究，超過 50% 的軟體 bug 屬於 UI 和視覺顯示問題，但傳統的功能測試腳本幾乎完全無法偵測這類缺陷——它們驗的是「功能有沒有動」，不是「畫面長什麼樣子」。
...
- [Percy Visual Testing Documentation - BrowserStack](https://www.browserstack.com/docs/percy/overview)
- [Playwright Screenshot Testing - Playwright Docs](https://playwright.dev/docs/test-screenshots)
- [Applitools Visual AI Testing Documentation](https://applitools.com/docs/)
- [Visual Testing Handbook - Storybook](https://storybook.js.org/tutorials/visual-testing-handbook/)
- [Google Testing Blog: Visual Regression Testing](https://testing.googleblog.com/)
