...
根據 Google 與 Deloitte 合作的研究，行動網站速度每提升 0.1 秒，轉換率平均上升 8%；Akamai 的報告則指出，2 秒的回應延遲會讓跳出率比 1 秒時高出 50%。效能不只是技術指標，是直接影響商業結果的因素。然而很多團隊對「效能測試」的理解還停留在壓測，沒有考慮到更複雜的流量模式。
...
- [k6 官方文件](https://k6.io/docs/) — Grafana k6 效能測試框架完整文件
- [k6：負載測試類型說明](https://k6.io/docs/test-types/) — Spike、Soak、Stress、Load test 的定義與腳本範例
- [Google：速度對商業指標的影響](https://web.dev/performance/) — Google Web 效能資源與研究報告集
- [DORA 2024 研究報告](https://dora.dev/research/2024/dora-report/) — 效能測試整合進 CI/CD 對交付品質的影響
- [Martin Fowler：微服務測試策略](https://martinfowler.com/articles/microservice-testing/) — 分層測試策略，效能測試在其中的定位
