...
- [Google Testing Blog — Hermetic Servers](https://testing.googleblog.com/2012/10/hermetic-servers.html) — Google 如何隔離測試環境加速 CI
- [Google DORA — State of DevOps 2024](https://dora.dev/research/2024/dora-report/) — CI 執行時間與交付頻率的關聯研究
- [GitHub Actions — Caching Dependencies](https://docs.github.com/en/actions/writing-workflows/choosing-what-your-workflow-does/caching-dependencies-to-speed-up-workflows) — CI 快取策略官方文件
- [Pytest-xdist — Parallel Testing](https://pytest-xdist.readthedocs.io/en/latest/) — pytest 平行化測試外掛文件
- [Thoughtworks — CI Pipeline Optimization](https://www.thoughtworks.com/insights/blog/microservices/optimizing-ci-pipelines) — CI Pipeline 最佳化實踐
