...
2016 年，Google 的工程師在研究報告中揭露：Google 內部測試套件每天約有 **1.5% 的測試是 flaky 的**，這些 flaky test 每次觸發都需要人工排查，合計消耗了大量工程師時間——而且 flaky test 讓開發者養成「失敗了先 re-run 一次看看」的習慣，讓整個測試套件的信任度逐漸崩解。
...
- [AI Augmented Testing for Flaky Test Detection - Kobiton](https://kobiton.com/guides/ai-augmented-testing-flaky-test-detection-mobile-apps/)
- [Playwright Best Practices - Playwright Docs](https://playwright.dev/docs/best-practices)
- [5 Best Self-Healing Mobile Test Automation Tools 2026 - Drizz](https://www.drizz.dev/discover/self-healing-mobile-test-automation-tools)
