...
這個循環，我見過不只一次。而且它幾乎每次都以同樣的方式結束：表面上是「需求寫得不夠清楚」，但實際上是 **QA 進入需求的時間點太晚了**。
...
- *[Who Owns Quality in a Scrum Team — u-tor.com](https://u-tor.com/topic/who-owns-quality-in-a-scrum-team-explained)*
