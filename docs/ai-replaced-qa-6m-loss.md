...
Capgemini《World Quality Report 2024–25》指出，全球已有超過半數的企業正計畫大幅擴展 AI 驅動測試——但同份報告也特別警示，在缺乏人工監督的架構下，AI 自動化帶來的決策風險遠比省下的成本更難量化。
...
根據 DORA 2024 年的研究，高效能工程團隊和低效能團隊最關鍵的差距之一，在於人工判斷介入的速度——高效能團隊能在一小時內偵測並回應異常，而這個速度依賴的是人對系統行為「不對勁」的直覺，而不是自動化腳本的觸發。
...
- [AI replaces QA team and triggers $6m loss — QA Financial](https://qa-financial.com/ai-replaces-qa-team-and-triggers-6m-loss-do-banks-risk-losing-judgement/)
...
- [Testing in Production, the safe way — Martin Fowler](https://martinfowler.com/articles/testing-in-production.html)
