...
根據 Ministry of Testing 的年度 State of Testing 調查，探索測試是業界採用率最高的測試技術之一，超過 80% 的測試工程師日常使用。但能清楚說明探索測試覆蓋範圍的團隊，仍屬少數——可見性的問題從來不是技術問題，是方法論問題。
...
- [Session Based Test Management Glossary - Ministry of Testing](https://www.ministryoftesting.com/software-testing-glossary/session-based-test-management-sbtm)
- [Exploratory Testing - Elisabeth Hendrickson, Test Obsessed](https://testobsessed.com/)
- [ISTQB Glossary: Exploratory Testing](https://glossary.istqb.org/en_US/term/exploratory-testing-1)
