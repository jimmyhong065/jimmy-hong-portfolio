...
根據 DORA 2024 年的研究，持續整合是高效能軟體交付團隊最一致的工程實踐——而行動 App 的 Appium 測試，是「難以放進 CI」這個痛點的極致體現。DORA 的資料同時指出，能自動化執行測試的團隊，其部署頻率和變更失敗率都顯著優於其他團隊。
...
- [GitHub Actions 官方文件](https://docs.github.com/en/actions) — GitHub CI/CD 平台完整文件
- [android-emulator-runner Action](https://github.com/ReactiveCircus/android-emulator-runner) — 在 GitHub Actions 上啟動 Android Emulator 的 Action
- [Appium 官方文件](https://appium.io/docs/en/latest/) — Appium 完整文件與 API 參考
- [DORA 2024 研究報告](https://dora.dev/research/2024/dora-report/) — 持續整合與自動化測試對軟體交付效能的影響
- [Allure Report 官方文件](https://allurereport.org/docs/) — 測試報告框架，支援 pytest、JUnit 等多種框架
