...
IDOR 屬於 OWASP Top 10 2021 的 A01:2021 Broken Access Control——這個類別在 2021 年首次登上第一名，取代了過去多年的 Injection 漏洞，代表存取控制問題已成為業界最普遍的安全弱點。根據 Verizon 2024 年資料外洩調查報告（DBIR），超過 40% 的資料外洩事件涉及授權控制失誤。而且這些問題大多數不需要高深的駭客技術，改一個 URL 參數就能觸發。
